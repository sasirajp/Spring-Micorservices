...
//    what filter does is it changes the path
//    http://localhost:8080/aggregate/product-service/v3/api-docs -> http://localhost:8080/aggregate/product-service/api-docs
